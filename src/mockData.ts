...
export const INITIAL_TASKS: Task[] = [
  {
    id: 't1',
    title: '大学英语六级历年真题听力精听与长难句背诵打卡',
    description: '完成2025年12月六级第一套真题听力精读并记录20个高频核心生词。',
    category: 'exam',
    priority: 'high',
  ...
  },
  {
    ...
    auto_tag_label: '实验代码',
    auto_tag_icon: 'FlaskConical',
  },
  {
    id: 't3',
    title: '计算机视觉前沿技术综述论文与开题报告撰写',
    description: '整理近3年CVPR/ICCV关于扩散模型与神经辐射场（NeRF）的顶级文献，撰写5000字调研报告。',
    category: 'homework',
    priority: 'high',
    ...
    auto_tag_label: '论文报告',
    auto_tag_icon: 'FileText',
  },
  {
    id: 't4',
    title: '“挑战杯”大学生创新创业竞赛校赛团队研讨会议',
    description: '智算楼502创客空间，与指导老师及团队成员讨论商业计划书（BP）与技术架构。',
    category: 'campus',
    priority: 'medium',
    deadline: '2026-09-03 15:30',
    is_completed: false,
    created_at: '2026-08-30',
    auto_tag_label: '会议研讨',
    auto_tag_icon: 'Users',
  ...
  {
    id: 't7',
    title: '数据结构与算法：完成单链表与双向循环链表C++代码实现',
